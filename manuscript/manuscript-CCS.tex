...
\documentclass[authordraft,sigconf]{acmart}
...
%\author{Alex J. Washburn}
%\email{academia@recursion.ninja}
%\orcid{0000-0001-7181-4288}
...
%\author{\IEEEauthorblockN{1\textsuperscript{st} Alex J. Washburn}
...
%0000-0001-7181-4288}
%\and
%\IEEEauthorblockN{2\textsuperscript{nd} Subash Shankar}
%\IEEEauthorblockA{\textit{Computer Science} \\
%\textit{Hunter College}\\
%New York, United States \\
...
\centering%
\begin{tabular}{c|c|l}%
{\Large \parbox{40mm}{\centering \CGKAsec\\Oracle Name and Inputs}}
& {\Large \parbox{30mm}{\centering Corresponding\\\CGKAdef Algorithm}}
& {\Large \parbox{60mm}{Brief description of Oracle Semantics\\\phantom{C}}}\\[3mm]
\hline
...
\end{tabular}
\vspace*{1mm}%
\caption{Description of \CGKAsec oracles and their corresponding \CGKAdef algorithms. \label{tab:oracle-proc}}%
\end{table*}
...
The \((T, C, N)\)-adversary \(\mathcal{A}\) demonstrates non-negligible advantage by ending the game via a challenge query to the \Oracle{chall}{} oracle, winning the \CGKAsec, if they can infer information of the shared TreeKEM root key.
...
% [SS] regardig figure, is deterministic multiplexing a phrase? Do you really mean deterministic choice? 
% [AW] I updated the figure. I ment to determinisitcally run two parralell calls.
...
The \Promela encoding \footnote{Source code: \url{https://github.com/recursion-ninja/Manuscript-2024-CCS/model}} of \CGKAmodN{N} produces all possible states and transitions of TreeKEM, and this representation is then supplied to a model checker for verification.
...
In contrast, all verification runs of \CGKAmodNT{N}{T} provide verification for an unbounded, finite series of communication epochs.
...
& 7 &  7 & \LTLPredicate{FSU} & 35,659s & \parbox{14mm}{\raggedleft 1.325 \siGiBytes} &  \BigNum{2.159}{7} & \BigNum{3.163}{7} \\
& 7 &  7 & \LTLPredicate{PCS} & 66,258s & \parbox{14mm}{\raggedleft 21.218 \siGiBytes} &  \BigNum{3.019}{8} & \BigNum{3.050}{7} \\
\midrule%
\multirow{2}{*}{\parbox{12mm}{\CGKAmodN{7}}}
& 7 & $\infty$ & \LTLPredicate{FSU} & \phantom{1}6,230s & \parbox{12mm}{\raggedleft 52.008 \siGiBytes} & \BigNum{1.142}{9} & \BigNum{2.082}{9} \\
& 7 & $\infty$ & \LTLPredicate{PCS} & 17,800s & \parbox{14mm}{\raggedleft 110.001 \siGiBytes} & \BigNum{2.060}{9} & \BigNum{3.462}{9} \\
\bottomrule%
\end{tabular}%
}% END font resize
\vspace*{1mm}%
...
& 16 & $\infty$ & \LTLPredicate{FSU}&  77,272s & \parbox{14mm}{\raggedleft 156.382 \siGiBytes} & \BigNum{3.034}{9} & \BigNum{6.591}{9} & \BigNum{2.598}{9} \\
& 16 & $\infty$ & \LTLPredicate{PCS} &  79,552s & \parbox{14mm}{\raggedleft 191.092 \siGiBytes} & \BigNum{3.475}{9} & \BigNum{7.969}{9} & \BigNum{4.386}{9} \\
\bottomrule%
\end{tabular}%
}% END font resize
\vspace*{1mm}%
\caption{\textbf{Performance measurements} of composed abstraction model verification results for $N = 16$ .\label{tab:verification-measurements}\hspace*{20mm}}%
\end{table*}%
